      ...
      >
        ...
        <div className='lg:ml-10'>
          ...
          <div className='grid grid-cols-2'>
            <Link to={linkToCode} className='text-xl md:text-2xl w-4/5 mx-auto' target='_blank'>
            ...
            <Link to={linkToPreview} className='text-xl md:text-2xl w-4/5 mx-auto' target='_blank'>
