...
const Navigation = () => {
  ...
  return (
    !typeAnimationIsPlaying && (
      <div className={`fade-in fixed right-0 top-0 flex text-3xl bg-[#262338] bg-opacity-70`}>
        <MdOutlineMenu
          className={`w-12 text-5xl mr-5 mt-2 lg:hidden ${menuIsOpen && ' rotate-left -rotate-90'}`}
